...
public class VisualBenchmark extends PApplet {
  ...
  Util.SolverType solversType[] = {Util.SolverType.CCD, Util.SolverType.TIK,
      Util.SolverType.TRIK, Util.SolverType.BFIK}; //Place Here Solvers that you want to compare

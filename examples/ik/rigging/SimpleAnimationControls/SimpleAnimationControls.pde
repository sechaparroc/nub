...
import java.util.TreeSet;
  ...
  String jsonPath = "Dummy_constrained.json";
  String shapePath = "Rigged_Hand.obj";
  String texturePath = "HAND_C.jpg";
  String interpolatorPath = "Dummy_jumps.json";
  ...
  public void setup() {
    ...
    //skeleton.enableIK();
    //skeleton.addTargets();
    skeleton.setDepth(true);
    skeleton.setBoneWidth(0.03f * mainScene.radius());
    ...
    setSceneRadius(skeleton, mainScene);
    mainScene.fit();
  ...
  void setSceneRadius(Skeleton skeleton, Scene scene){
    //Get max coordinate
    float max_dist = 0;  
